...
public class RealCheckBox extends CheckBox implements AutofitHelper.OnTextSizeChangeListener {
    ...
    public RealCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RealCheckBox(Context context, AttributeSet attrs, int defStyle) {
